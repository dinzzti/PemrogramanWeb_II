...
<?php if (empty($id_buku)) : ?>
    ...
    <section class="container1 green-text">
        ...
        <form action="" method="post">
            ...
            <div class="center">
                <button class="waves-effect waves-light green btn-small" type="submit" name="submit">
                    <i class="material-icons left">send</i>Submit
                </button>
                <a href="Buku.php" class="waves-effect waves-light grey btn-small">
...
<?php else : ?>
    ...
    <section class="container green-text">
        ...
        <form action="" method="post">
            ...
            <label class="black-text" for="tahun_terbit">Tahun Terbit:</label>
            <input type="date" name="tahun_terbit" id="tahun_terbit" required value="<?= $buku["tahun_terbit"] ?>">

            <div class="center">
                <button class="waves-effect waves-light green btn-small" type="submit" name="ubah">
