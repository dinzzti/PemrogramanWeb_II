...
<?php if (empty($id_member)) : ?>
    ...
    <section class="container1 blue-text">
        ...
        <form action="" method="post">
            ...
            <div class="center">
                <button class="waves-effect waves-light blue btn-small" type="submit" name="submit">
                    <i class="material-icons left">send</i>Submit
                </button>
                <a href="Member.php" class="waves-effect waves-light grey btn-small">
...
<?php else : ?>
    ...
    <section class="container blue-text">
        ...
        <form action="" method="post">
            ...
            <div class="center">
                <button class="waves-effect waves-light blue btn-small" type="submit" name="ubah">
